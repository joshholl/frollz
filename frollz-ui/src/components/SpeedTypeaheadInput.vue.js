...
for (const [suggestion, i] of __VLS_vFor((__VLS_ctx.suggestions))) {
    __VLS_asFunctionalElement1(__VLS_intrinsics.li, __VLS_intrinsics.li)({
        ...{ onPointerdown: (...[$event]) => {
                ...
                // @ts-ignore
                [onInput, close, moveDown, moveUp, selectHighlighted, onBlur, onFocus, rawInput, isOpen, isOpen, suggestions, suggestions, suggestions, listboxId, listboxId, highlightedIndex, highlightedIndex, optionId, $attrs, select,];
            } },
        key: (suggestion),
