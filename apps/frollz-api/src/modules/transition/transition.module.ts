...
@Module({
  ...
  providers: [
    {
      provide: TRANSITION_RULE_REPOSITORY,
      useClass: TransitionRuleKnexRepository,
    },
    {
      provide: TRANSITION_STATE_REPOSITORY,
      useClass: TransitionStateKnexRepository,
    },
    {
      provide: TRANSITION_PROFILE_REPOSITORY,
      useClass: TransitionProfileKnexRepository,
    },
    {
      provide: TRANSITION_METADATA_FIELD_REPOSITORY,
      useClass: TransitionMetadataFieldKnexRepository,
    },
    {
      provide: TRANSITION_STATE_METADATA_REPOSITORY,
      useClass: TransitionStateMetadataKnexRepository,
    },
    TransitionService,
  ],
